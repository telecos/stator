...
//! use stator_jse::inspector::heap_snapshot::{HeapSnapshotBuilder, start_tracking, stop_tracking, record_allocation};
//!
//! // Build a snapshot from an empty globals map.
//! let globals: HashMap<String, stator_jse::objects::value::JsValue> = HashMap::new();
