...
///
/// ```
/// use stator_jse::builtins::weak_set::{weak_set_new, weak_set_add, weak_set_has};
...
///
/// ```
/// use stator_jse::builtins::weak_set::weak_set_new;
///
/// let ws = weak_set_new();
/// ```
...
///
/// ```
/// use stator_jse::builtins::weak_set::{weak_set_new, weak_set_add, weak_set_delete};
/// use stator_jse::objects::heap_object::HeapObject;
///
/// let mut ws = weak_set_new();
/// let mut obj = HeapObject::new_null();
...
///
/// ```
/// use stator_jse::builtins::weak_set::{
