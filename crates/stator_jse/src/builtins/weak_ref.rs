...
///
/// ```
/// use stator_jse::builtins::weak_ref::{weak_ref_new, weak_ref_deref};
...
///
/// ```
/// use stator_jse::builtins::weak_ref::weak_ref_new;
/// use stator_jse::objects::heap_object::HeapObject;
///
/// let mut obj = HeapObject::new_null();
/// let wr = weak_ref_new(&raw mut obj).unwrap();
...
/// use std::cell::RefCell;
/// use std::rc::Rc;
/// use stator_jse::builtins::weak_ref::{weak_ref_new_plain, weak_ref_deref};
...
///
/// ```
/// use stator_jse::builtins::symbol::symbol_create;
/// use stator_jse::builtins::weak_ref::{weak_ref_deref, weak_ref_new_symbol};
/// use stator_jse::objects::value::JsValue;
///
...
///
/// ```
/// use stator_jse::builtins::weak_ref::{weak_ref_new, weak_ref_deref, weak_ref_clear};
/// use stator_jse::objects::heap_object::HeapObject;
/// use stator_jse::objects::value::JsValue;
///
/// let mut obj = HeapObject::new_null();
...
///
/// ```
/// use stator_jse::builtins::weak_ref::{weak_ref_new, weak_ref_has_target, weak_ref_clear};
/// use stator_jse::objects::heap_object::HeapObject;
///
/// let mut obj = HeapObject::new_null();
/// let mut wr = weak_ref_new(&raw mut obj).unwrap();
