...
mod tests {
    ...
    // ── Missing builtins: Object.defineProperties extended ───────────────
    ...
    // ── Missing builtins: Object.getOwnPropertyNames extended ────────────
    ...
    /// `Object.getOwnPropertyNames` throws for undefined.
    #[test]
    fn test_gopn_undefined_throws() {
        let result = global_eval("Object.getOwnPropertyNames(undefined)");
        assert!(result.is_err());
    }

    // ── Missing builtins: Object.getOwnPropertySymbols extended ──────────
    ...
    // ── Missing builtins: Object.preventExtensions extended ──────────────
    ...
    // ── Missing builtins: Object.seal extended ───────────────────────────
    ...
    // ── Missing builtins: Object.freeze extended ─────────────────────────
    ...
    // ── Missing builtins: Array.isArray extended ─────────────────────────
    ...
    fn test_array_is_array_string() {
        let result = global_eval("Array.isArray('hello')").unwrap();
        assert_eq!(result, JsValue::Boolean(false));
    }
    ...
    // ── Missing builtins: Object.getOwnPropertyDescriptors extended ─────
