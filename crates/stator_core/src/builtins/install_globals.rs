...
mod tests {
    ...
    // ── Generator and iterator protocol conformance ──────────────────────

    /// Generator.prototype.next() basic — yields values in order.
    #[test]
    ...
    /// Generator.prototype.next(value) — pass values into yield expressions.
    #[test]
    ...
    /// Generator return value — `return value` inside generator sets done:true.
    #[test]
    ...
    /// Generator.prototype.throw — throws into a generator with try/catch.
    #[test]
    ...
    /// Generator as iterable — for-of iterates yielded values.
    #[test]
    ...
    /// Generator expression — `var gen = function*() { ... }`.
    #[test]
    ...
    /// Infinite generator — partial consumption with break.
    #[test]
    ...
    /// Generator with no yields — immediately done.
    #[test]
    ...
    /// Nested generators — outer yields from inner via yield*.
    #[test]
    ...
    /// Generator with try/finally — finally runs on normal completion.
    #[test]
    ...
    /// Generator with try/finally — finally runs on .return() call.
    #[test]
