...
mod tests {
    ...
    // ── Error and exception handling conformance ────────────────────────────

    /// try/catch — catch receives the thrown Error object's message.
    #[test]
    ...
    /// try/catch/finally — finally always runs and its side-effect is visible.
    #[test]
    ...
    /// throw a number — catch receives the numeric value.
    #[test]
    fn e2e_throw_number() {
    ...
    /// throw a string — catch receives the string value.
    #[test]
    fn e2e_throw_string() {
    ...
    /// throw null — catch receives null.
    #[test]
    fn e2e_throw_null() {
    ...
    /// throw undefined — catch receives undefined.
    #[test]
    ...
    /// throw boolean — catch receives the boolean value.
    #[test]
    ...
    /// throw an object literal — catch receives the object.
    #[test]
    fn e2e_throw_object() {
    ...
    /// Nested try/catch — inner catch handles, outer does not see it.
    #[test]
    ...
    /// Nested try/catch — inner does not catch, outer catches.
    #[test]
    ...
    /// try/finally without catch — finally runs, exception propagates.
    #[test]
    ...
    /// new Error() with no message — message defaults to empty string.
    #[test]
    ...
    /// Custom error subclass — instanceof checks.
    #[test]
    ...
    /// try/catch/finally — all three execute in order.
    #[test]
