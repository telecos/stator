...
///
/// ```
/// use stator_jse::builtins::number::number_is_finite;
///
...
///
/// ```
/// use stator_jse::builtins::number::number_is_integer;
///
...
///
/// ```
/// use stator_jse::builtins::number::number_is_nan;
///
...
///
/// ```
/// use stator_jse::builtins::number::{number_is_safe_integer, NUMBER_MAX_SAFE_INTEGER};
///
...
///
/// ```
/// use stator_jse::builtins::number::number_parse_int;
///
...
///
/// ```
/// use stator_jse::builtins::number::number_parse_float;
///
...
///
/// ```
/// use stator_jse::builtins::number::number_to_fixed;
///
...
///
/// ```
/// use stator_jse::builtins::number::number_to_precision;
///
...
///
/// ```
/// use stator_jse::builtins::number::number_to_exponential;
///
...
///
/// ```
/// use stator_jse::builtins::number::number_to_string_radix;
///
