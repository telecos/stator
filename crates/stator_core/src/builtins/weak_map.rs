...
///
/// ```
/// use stator_core::builtins::weak_map::{weak_map_new, weak_map_set, weak_map_has};
...
///
/// ```
/// use stator_core::builtins::weak_map::weak_map_new;
///
/// let wm = weak_map_new();
/// ```
...
///
/// ```
/// use stator_core::builtins::weak_map::{weak_map_new, weak_map_set, weak_map_get};
/// use stator_core::objects::heap_object::HeapObject;
/// use stator_core::objects::value::JsValue;
///
/// let mut wm = weak_map_new();
...
///
/// ```
/// use stator_core::builtins::weak_map::{weak_map_new, weak_map_get};
/// use stator_core::objects::heap_object::HeapObject;
/// use stator_core::objects::value::JsValue;
///
/// let wm = weak_map_new();
...
///
/// ```
/// use stator_core::builtins::weak_map::{weak_map_new, weak_map_set, weak_map_delete};
/// use stator_core::objects::heap_object::HeapObject;
/// use stator_core::objects::value::JsValue;
///
/// let mut wm = weak_map_new();
...
///
/// ```
/// use stator_core::builtins::weak_map::{
