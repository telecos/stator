...
impl InterpreterFrame {
    ...
    #[allow(dead_code)]
    #[inline]
    fn get_or_init_mono_cache(&mut self) -> &mut MonoLoadCache {
    ...
    #[inline]
    fn get_or_init_poly_cache(&mut self) -> &mut PolyLoadCache {
    ...
    #[inline]
    fn get_or_init_shape_load_ic(&mut self) -> &mut ShapeIcCache {
    ...
    #[inline]
    fn get_or_init_shape_store_ic(&mut self) -> &mut ShapeIcCache {
        let ic_slots = self.bytecode_array.feedback_metadata().slot_count() as usize;
        self.shape_store_ic
            .get_or_insert_with(|| Box::new(HashMap::with_capacity(ic_slots)))
            .as_mut()
    ...
    #[inline]
    fn get_or_init_string_cache(&mut self) -> &mut StringCache {
    ...
    pub fn get_string_constant(&mut self, idx: u32) -> StatorResult<Rc<str>> {
        ...
        self.get_or_init_string_cache().insert(idx, Rc::clone(&s));
        Ok(s)
    }
